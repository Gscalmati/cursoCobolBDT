...
Funcion procesarSocio (importeSocio Por Valor, modalidadOp Por Valor, montoOpTransf Por Referencia, cantTransferencias Por Referencia)
	Si modalidadOp = 'T'
		acumulador(montoOpTransf, importeSocio)
		aumentarEn1(cantTransferencias)
	FinSi
FinFuncion
...
Funcion finSocio(nroSoc Por Valor, montoOpTransf Por Valor, cantTransferencias Por Valor, cantSociosConTransf Por Referencia, numSocioMasTransf Por Referencia, cantSocioMasTransf Por Referencia, totalGeneral Por Referencia)
	...
	Si cantTransferencias > 0 Entonces
		aumentarEn1(cantSociosConTransf)
		definirMaximo(cantTransferencias, nroSoc, cantSocioMasTransf, numSocioMasTransf)
	FinSi
	acumulador(totalGeneral, montoOpTransf)
FinFuncion
...
// Funciones Extras
Funcion aumentarEn1(var1 Por Referencia)
	var1 = var1 +1
FinFuncion

Funcion definirMaximo(valorActual Por Referencia, nomValorActual Por Referencia, valorMax Por Referencia, nomValorMax Por Referencia)
	Si valorActual > valorMax Entonces
		valorMax = valorActual
		nomValorMax = nomValorActual
	FinSi
FinFuncion

Funcion acumulador(acum Por Referencia, valParaAcumular Por Valor)
	acum = acum + valParaAcumular
FinFuncion
